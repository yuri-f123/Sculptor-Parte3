...
public:
  ...
  /**
   * @brief isItOn - Função utilizada para determinar se o voxel da posição dada está ligado ou não
   * @param i - Posição do voxel no eixo x
   * @param j - Posição do voxel no eixo y
   * @param k - Posição do voxel no eixo z
   * @return Retorna 1 se estiver ligado e 0 se não estiver
   */
  int isItOn(int i, int j, int k);
  /**
   * @brief getR - Função que retorna o valor r da cor de um voxel na posição dada
   * @param i - Posição do voxel no eixo x
   * @param j - Posição do voxel no eixo y
   * @param k - Posição do voxel no eixo z
   * @return Retorna o valor r (de 0 a 255) da cor do voxel
   */
  int getR(int i, int j, int k);
  /**
   * @brief getG - Função que retorna o valor g da cor de um voxel na posição dada
   * @param i - Posição do voxel no eixo x
   * @param j - Posição do voxel no eixo y
   * @param k - Posição do voxel no eixo z
   * @return Retorna o valor g (de 0 a 255) da cor do voxel
   */
  int getG(int i, int j, int k);
  /**
   * @brief getB - Função que retorna o valor b da cor de um voxel na posição dada
   * @param i - Posição do voxel no eixo x
   * @param j - Posição do voxel no eixo y
   * @param k - Posição do voxel no eixo z
   * @return Retorna o valor b (de 0 a 255) da cor do voxel
   */
