...
int Sculptor::getR(int i, int j, int k){
    return v[i][j][k].r*255;
}

int Sculptor::getG(int i, int j, int k){
    return v[i][j][k].g*255;
}

int Sculptor::getB(int i, int j, int k){
    return v[i][j][k].b*255;
}
